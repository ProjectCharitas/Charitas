...
Source: "..\PowerShell-7.0.0-win-x86.msi"; DestDir: "{tmp}"; Flags: dontcopy; Check: UserNeedsPowerShell
...
begin
  ...
  begin
    ...
    begin
      ...
      try
        ExtractTemporaryFile('PowerShell-7.0.0-win-x86.msi');
        if not Exec('msiexec.exe', ExpandConstant('/package {tmp}\PowerShell-7.0.0-win-x86.msi'), '', SW_SHOW, ewWaitUntilTerminated, ResultCode) then
        begin
