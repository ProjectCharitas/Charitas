...
begin
  ...
  begin
    ...
    idpAddFile('https://github.com/PowerShell/PowerShell/releases/download/v7.0.1/PowerShell-7.0.1-win-x64.msi', ExpandConstant('{tmp}\PowerShellCorex64.msi'));
...
begin
  ...
  begin
    ...
    begin
      ...
      try
        if not Exec('msiexec.exe', ExpandConstant('/package {tmp}\PowerShellCorex64.msi'), '', SW_SHOW, ewWaitUntilTerminated, ResultCode) then
        begin
