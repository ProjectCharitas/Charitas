...
if ($CUDAVersion -lt [System.Version]("10.1.0")) { 
    $HashSHA256 = "2A80F3D8E31BF8775B91630B3B04ADF77C6C4E6E32161DA6BCB7445B2C90AF6F"
    $Uri = "https://github.com/technobyl/CryptoDredge/releases/download/v0.22.0/CryptoDredge_0.22.0_cuda_9.2_windows.zip"
}
else { 
    $HashSHA256 = "867C9B13051BA34DD95648EEBE26D2283F7B5BCDB120B154A0C6128D1CCB761D"
